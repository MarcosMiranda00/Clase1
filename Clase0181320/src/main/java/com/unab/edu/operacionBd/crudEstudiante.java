...
public class crudEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tb_SeleccionarId = new javax.swing.JTable();
        ...
        tb_SeleccionarId.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tb_SeleccionarId.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tb_SeleccionarIdMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tb_SeleccionarId);
    ...
    private void tb_SeleccionarIdMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_SeleccionarIdMouseClicked
        int fila = tb_SeleccionarId.getSelectedRow();

        String IdPersona = String.valueOf(tb_SeleccionarId.getValueAt(fila, 0));
        txtIdPerson.setText(IdPersona);
    }//GEN-LAST:event_tb_SeleccionarIdMouseClicked
    ...
    private javax.swing.JTable tb_SeleccionarId;
